...
public class MyConstant {
        ...
        // Swagger Info
        public static final String SWAGGER_INFO_TITLE = "AgriLoans";
        public static final String SWAGGER_INFO_DESCRIPTION = "AgriLoans backend API documentation";
        public static final String SWAGGER_INFO_VERSION = "1.0.0";
        public static final String SWAGGER_INFO_CONTACT_NAME = "AgriLoans";
        public static final String SWAGGER_INFO_CONTACT_EMAIL = "AgriLoans@gmail.com";
        public static final String SWAGGER_INFO_CONTACT_URL = "https://AgriLoans.com";
